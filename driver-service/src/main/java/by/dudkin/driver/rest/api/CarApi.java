...
public interface CarApi {
    ...
    ResponseEntity<CarResponse> get(@Parameter(name = "carId", description = "The ID of the car.", required = true, in = ParameterIn.PATH) @PathVariable("carId") @Min(0) long carId);
    ...
    ResponseEntity<CarResponse> update(
            ...
            @PathVariable("carId") @Min(0) long carId,
    ...
    ResponseEntity<Void> delete(@Parameter(name = "carId", description = "The ID of the car.", required = true, in = ParameterIn.PATH) @PathVariable("carId") @Min(0) long carId);
